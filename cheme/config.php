...
//$db = 'pgsql:host=localhost;dbname=phpcas';   This stuff came with the file
//$db = 'mysql:host=localhost;dbname=phpcas';
/*$db_user = 'phpcasuser';
$db_password = 'mysupersecretpass';
$db_table = 'phpcastabel';
$driver_options = '';*/                // But I decided to make them constants instead.

define("DB_SERVER", "webmysql.et.byu.edu");
define("DB_USER", "chemalumni");
define("DB_PASS", "alumni123");
define("DB_NAME", "chemalumni");
