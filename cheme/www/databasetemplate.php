...
<?php
	...
	$pageTitle = "Database Template | Chemical Engineering";
...
<title><?php echo $pageTitle; ?></title>
	...
	<div id="content" class="wrapper two-sidebars clearfix">
		<div id="breadcrumb">
			...
			| <a href="grad.php">Alumni & Friends</a> | Database Template</div>
		<h1>Database Template</h1>
		<hr />
<div class="sidebar">
...
<div id="main-content" style="width:620px;">
		...
		$query = "INSERT INTO news_items(title, picture, paragraph) VALUES ('$_POST[title]', '$_POST[picture]', '$_POST[paragraph]')";

			$newsItem = mysql_query($query, $connection);
		
				if(!newsItem){
					die("Database connection failed: " . mysql_error());
				}else{
						echo "News Item: " . $title . " " . "was successfully added to the database!";
