	...
	<h3>2. Complete the following pre-professional courses:</h3>
		...
		CH EN 291 Preprofessional Seminar<br />
		...
		Phscs 220 Principles of Physics 3</p>
...
<h3>3. Complete the following professional courses</h3>
	<hr />
 ...
 <h3>4. Complete the following supporting courses:</h3>
 	<hr />
		...
		Stat 332 Statistics for Engineers and Scientists<br />
		
 <h3>5. Complete technical electives (12 hours minimum) satisfying the following requirements:</h3>
		<ul>
		...
		<li>Complete 6 hours of advanced (300-level or above)
		engineering course work from any of the following
		Environmental Engineering, Electrical and Computer
		Engineering, Mechanical Engineering, or the School of
		Technology</li><br />
		<li>Complete 4 hours of advanced (300-level or above) course
		work from  an engineering, math, science, or business
		department. Only 1 hour of Chem 497 is acceptable. No
		more than 3 hours of Ch En 498R (only 2 hours if Chem
		497R is taken) may be applied to the program. Phscs 281 is
		approved for this requirement.</li>
		
		
		
		</ul>
 <h3>6. Complete a basic competency exam (L3 Exam) administered by the Chemical
